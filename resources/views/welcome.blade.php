        ...
        <div className="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div className="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ route('user.dashboard') }}" className="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
                    @else
            ...
            <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div className="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div className="text-center text-sm text-gray-500 sm:text-left">
                        <div className="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="-mt-px w-5 h-5 text-gray-400">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="ml-4 -mt-px w-5 h-5 text-gray-400">
